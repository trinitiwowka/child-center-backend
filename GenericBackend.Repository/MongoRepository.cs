...
namespace GenericBackend.Repository
{
        ...
        
    {
        ...
        {
            get { return this.collection.ToString(); }
        }
        ...
        {
            //TODO check this 
            this.collection.ReplaceOne(x => x.Id.CompareTo(entity.Id) == 0, entity, new UpdateOptions { IsUpsert = true} );
        ...
        public virtual void Update(IEnumerable<T> entities)
        {
            ...
            {
                this.collection.ReplaceOne(x => x.Id.ToString() == entity.Id.ToString(), entity, new UpdateOptions { IsUpsert = true});
            }
        }
        ...
        public virtual void Delete(TKey id)
        {
            ...
            {
                this.collection.DeleteOne(x => x.Id.ToString() == id.ToString());
            }
            else
            {
                this.collection.DeleteOne(x => x.Id.ToString() == id.ToString());
